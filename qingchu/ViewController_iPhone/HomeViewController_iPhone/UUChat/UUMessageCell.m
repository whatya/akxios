...
- (void)setMessageFrame:(UUMessageFrame *)messageFrame{
    ...
    NSData *dataHeadImage = [Base64 decodeString: message.strIcon];
    UIImage *headImage = [UIImage imageWithData: dataHeadImage];
    if (!headImage) {
        headImage = [UIImage imageNamed:@"profileUserAvatar"];
    }
